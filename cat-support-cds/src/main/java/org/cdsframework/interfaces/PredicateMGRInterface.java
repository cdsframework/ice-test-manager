 ...
 * @param <Y>
 */
public interface PredicateMGRInterface<T extends BasePredicateDTO & PredicateInterface, Y extends BasePredicatePartDTO & PredicatePartInterface> {
    ...
    public T getFullPredicateDTO(T dto);
    ...
    public boolean isOverridable(Y predicatePart);
}
