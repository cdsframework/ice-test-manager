...
@Named
@RequestScoped
public class DataModelClassNodeConverter extends BaseDTOConverter<DataModelClassNodeDTO> {

    @Inject
    private DataModelClassNodeDTOList dataModelClassNodeDTOList;

    public DataModelClassNodeConverter() {
        super(DataModelClassNodeConverter.class);
    }
