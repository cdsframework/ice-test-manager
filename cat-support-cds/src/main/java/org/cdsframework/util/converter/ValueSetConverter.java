...
@Named
@RequestScoped
public class ValueSetConverter extends BaseDTOConverter<ValueSetDTO> {

    @Inject
    private ValueSetDTOList valueSetDTOList;

    public ValueSetConverter() {
        super(ValueSetConverter.class);
    }

    @Override
    protected void initialize() {
        setBaseDTOList(valueSetDTOList);
    }

    @Override
    protected String getStringFromObject(ValueSetDTO item) {
        return item != null ? item.getValueSetId(): null;
    }
