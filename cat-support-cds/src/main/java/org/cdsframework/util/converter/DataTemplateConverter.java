...
@Named
@RequestScoped
public class DataTemplateConverter extends BaseDTOConverter<DataTemplateDTO> {

    @Inject
    private DataTemplateDTOList dataTemplateDTOList;

    public DataTemplateConverter() {
        super(DataTemplateConverter.class);
    }

    @Override
    protected void initialize() {
        setBaseDTOList(dataTemplateDTOList);
    }

    @Override
    protected String getStringFromObject(DataTemplateDTO item) {
        return item != null ? item.getTemplateId() : null;
    }
