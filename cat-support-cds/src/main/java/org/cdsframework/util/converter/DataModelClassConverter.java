...
@Named
@RequestScoped
public class DataModelClassConverter extends BaseDTOConverter<DataModelClassDTO> {

    @Inject
    private DataModelClassDTOList dataModelClassDTOList;

    public DataModelClassConverter() {
        super(DataModelClassConverter.class);
    }

    @Override
    protected void initialize() {
        setBaseDTOList(dataModelClassDTOList);
    }

    @Override
    protected String getStringFromObject(DataModelClassDTO item) {
