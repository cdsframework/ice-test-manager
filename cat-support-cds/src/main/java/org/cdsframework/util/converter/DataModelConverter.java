...
@Named
@RequestScoped
public class DataModelConverter extends BaseDTOConverter<DataModelDTO> {

    @Inject
    private DataModelDTOList dataModelDTOList;

    public DataModelConverter() {
        super(DataModelConverter.class);
    }

    @Override
    protected void initialize() {
        setBaseDTOList(dataModelDTOList);
    }

    @Override
    protected String getStringFromObject(DataModelDTO item) {
        return item != null ? item.getModelId() : null;
    }
