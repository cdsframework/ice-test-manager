...
@Named
@ViewScoped
public class CriteriaResourceParamMGR extends BaseModule<CriteriaResourceParamDTO> {
    private static final long serialVersionUID = 3352264368390854639L;

    @Override
    protected void initialize() {
        setBaseHeader("Criteria Resource Parameter");
