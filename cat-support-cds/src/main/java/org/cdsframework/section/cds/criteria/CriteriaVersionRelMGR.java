...
@Named
@ViewScoped
public class CriteriaVersionRelMGR extends BaseModule<CriteriaVersionRelDTO> {

    private static final long serialVersionUID = 8998158496302459545L;

    @Override
    protected void initialize() {
        setBaseHeader("Criteria Version Relationship");
