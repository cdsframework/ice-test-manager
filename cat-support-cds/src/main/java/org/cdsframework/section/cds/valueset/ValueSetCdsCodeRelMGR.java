...
@Named
@ViewScoped
public class ValueSetCdsCodeRelMGR extends BaseModule<ValueSetCdsCodeRelDTO> {
    ...
    protected void initialize() {
        this.setBaseHeader("Value Set Related Code");
    ...
    public void clearSearchMain(ActionEvent actionEvent) {
        ...
        String text = (String) getSearchCriteriaDTO().getQueryMap().get("text");
        ...
        if (!StringUtils.isEmpty(text)) {
            getSearchCriteriaDTO().getQueryMap().put("text", text);
        }
    }
