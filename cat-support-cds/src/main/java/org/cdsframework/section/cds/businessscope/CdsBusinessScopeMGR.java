 ...
 */
package org.cdsframework.section.cds.businessscope;
...
import org.cdsframework.section.cds.version.CdsVersionMGR;
...
@Named
@ViewScoped
public class CdsBusinessScopeMGR extends BaseModule<CdsBusinessScopeDTO> {

    private static final long serialVersionUID = -5706514608094838093L;

    @Inject
    private CdsBusinessScopeDTOList cdsBusinessScopeDTOList;
    @Inject
    CdsVersionMGR cdsVersionMGR;
    ...
    protected void initialize() {
        ...
        registerChild(CdsVersionDTO.ByBusinessScopeId.class, cdsVersionMGR);
        //addOnRowSelectChildClassDTO(CdsVersionDTO.class);
    ...
    public void registerTabComponents() {
        ...
        getTabService().registeredUIComponent(0, cdsVersionMGR);
    }
