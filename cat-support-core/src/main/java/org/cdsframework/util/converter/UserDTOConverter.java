...
@Named
@RequestScoped
public class UserDTOConverter extends BaseDTOConverter<UserDTO> {

    @Inject
    private UserDTOList userDTOList;

    public UserDTOConverter() {
        super(UserDTOConverter.class);
    }

    @Override
    protected void initialize() {
        setBaseDTOList(userDTOList);
    }

    @Override
    protected String getStringFromObject(UserDTO item) {
